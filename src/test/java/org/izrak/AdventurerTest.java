...
class AdventurerTest {
    ...
    @Test
    void should_be_at_same_position_given_an_empty_command_list() throws AdventurerException{
        //Given
    ...
    @Test
    void should_be_at_same_position_and_facing_east_given_D_command() throws AdventurerException{
        //Given
        Position position = new Position(0, 0);
        Orientation orientation = Orientation.N;
        Map map = new Map(10, 10);
    ...
    @Test
    void should_be_at_same_position_and_facing_west_given_G_command() throws AdventurerException{
        //Given
        Position position = new Position(0, 0);
        Orientation orientation = Orientation.N;
        Map map = new Map(10, 10);
